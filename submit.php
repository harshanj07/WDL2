...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($product1 == 1) {
        $sql1 = "INSERT INTO orders (first_name, last_name, email, phone_number, quantity, size) VALUES ('$fname', '$lname', '$email', '$phno', '$quantity1', '$size1')";
    ...
    if ($product2 == 2) {
        $sql2 = "INSERT INTO orders (first_name, last_name, email, phone_number, quantity, size) VALUES ('$fname', '$lname', '$email', '$phno', '$quantity2', '$size2')";
